			...
			<div id="nav"> 		
				...
				<div id="bizq" class="inline">
					<div class="botones inline">
						<a href="../views/DayViewServlet?goTo=today"><button>Hoy</button></a>
						<a href="../views/DayViewServlet?goTo=backward"><button>‹</button></a>
						<a href="../views/DayViewServlet?goTo=forward"><button>›</button></a>
						${wday} ${sday}
					</div>
				</div>
