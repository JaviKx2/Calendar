			...
			<div id="nav"> 		
				...
				<div id="bizq" class="inline">
					<div class="botones inline">
						<a href="../views/WeekViewServlet?goTo=today"><button>Hoy</button></a>
						<a href="../views/WeekViewServlet?goTo=backward"><button>‹</button></a>
						<a href="../views/WeekViewServlet?goTo=forward"><button>›</button></a>
						${startDay} | ${endDay}
					</div>
				</div>
